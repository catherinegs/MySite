...
var gDocTable = new Array(
   ...
   new hrefList("slide0042.htm", 1, 2),
   ...
   new hrefList("slide0049.htm", 1, 9),
   new hrefList("slide0050.htm", 1, 10),
   new hrefList("slide0051.htm", 1, 11),
   new hrefList("slide0052.htm", 1, 12),
   new hrefList("slide0053.htm", 1, 13),
   new hrefList("slide0054.htm", 1, 14),
   new hrefList("slide0055.htm", 1, 15),
   new hrefList("slide0056.htm", 1, 16),
   new hrefList("slide0057.htm", 1, 17),
   new hrefList("slide0058.htm", 1, 18),
   new hrefList("slide0059.htm", 1, 19),
   new hrefList("slide0060.htm", 1, 20)
);
...
var g_baseURL = gtmpstr.substr(0, gtmpstr.lastIndexOf("/") ) + "/" + "gourdinstagemaster1sonsdesseismes_files";
var g_showoutline = 1;
  ...
  if ( (msie || isnav ) && ( (os < 0 && ver >= 4 ) || ( os >= 0 && ver >= 5 ) || (os >=0 && msie < 0 && ver >= 4 ) )  ){
	if ( msie >= 0 )  {
		if ( isIEFiles > 0 )
			...
			window.location.replace(  "gourdinstagemaster1sonsdesseismes_files/error.htm" );
	}
	else {
