...
var g_baseURL = gtmpstr.substr(0, gtmpstr.lastIndexOf("/") ) + "/" + "GOURDIN_CORRELATION%20BRUIT%20DE%20FOND%20SISMIQUE_files";
var g_showoutline = 1;
  ...
  if ( (msie || isnav ) && ( (os < 0 && ver >= 4 ) || ( os >= 0 && ver >= 5 ) || (os >=0 && msie < 0 && ver >= 4 ) )  ){
	if ( msie >= 0 )  {
		if ( isIEFiles > 0 )
			...
			window.location.replace(  "GOURDIN_CORRELATION%20BRUIT%20DE%20FOND%20SISMIQUE_files/error.htm" );
	}
	else {
